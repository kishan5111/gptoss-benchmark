...
# Benchmark: openai/gpt-oss-120b (MXFP4) on RTX Pro 6000 Blackwell
#
# Run on an RTX Pro 6000 Blackwell instance:
#   chmod +x gptoss_120b_a6000.sh
#   ./gptoss_120b_a6000.sh
#
# Logs everything to ./logs/rtx6000_bw/
# Summary JSON written to ./results/rtx6000_bw.json
# =============================================================================
...
log "========================================================"
log " GPT-OSS 120B Benchmark — RTX Pro 6000 Blackwell"
log " Model: $MODEL  |  Precision: MXFP4 native"
log " VRAM: 96 GB GDDR7 — fits model with ~38 GB KV headroom"
log "========================================================"
